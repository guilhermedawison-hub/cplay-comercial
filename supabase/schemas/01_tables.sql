...
alter table public.deals
    add constraint deals_product_id_fkey foreign key (product_id) references public.products(id) on update cascade on delete set null;

alter table public.deals
    add constraint deals_lead_source_id_fkey foreign key (lead_source_id) references public.lead_sources(id) on update cascade on delete set null;

alter table public.deals
    add constraint deals_primary_contact_id_fkey foreign key (primary_contact_id) references public.contacts(id) on update cascade on delete restrict;
...
create index deals_product_id_idx on public.deals using btree (product_id);
